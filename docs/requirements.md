...
### 5.3 ビルド環境
- **TECH-008**: Node.js 24以上を使用する（開発環境と本番環境で同じバージョンを使用）
  - 開発環境とDocker環境で同じバージョンを使用することで、環境の差異による問題を防ぐ
  - Astro 5はNode.js v18.20.8以降、v20.3.0以降、またはv22.0.0以降を公式にサポート（v24は後方互換性により動作する可能性が高い）
